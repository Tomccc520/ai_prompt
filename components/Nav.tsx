                  ...
                  <div className="sm:flex sm:items-center flex-col">
                    ...
                    <h3 className="text-2xl leading-6 font-bold text-black-900 flex justify-center items-center" id="modal-headline">
                      ...
                      <form className="mt-5 sm:flex sm:items-center flex-col">
                        ...
                        <label htmlFor="title" className=" text-left inline-block text-gray-700 text-sm font-bold mb-2">
                            标题
                          </label>
                          <input
                            type="text"
                        ...
                        <div className="w-full sm:max-w-xs mb-4 flex flex-col">
                        <label htmlFor="slogan" className="text-left  inline-block text-gray-700 text-sm font-bold mb-2">
                            描述
                          </label>
                          <input
                            type="text"
                        ...
                        <div className="w-full sm:max-w-xs mb-4 flex flex-col">
                        <label htmlFor="placeholder" className="text-left  inline-block text-gray-700 text-sm font-bold mb-2">
                            使用文字案例
                          </label>
                          <input
                            type="text"
                        ...
                        <div className="w-full sm:max-w-xs mb-4 flex flex-col">
                        <label htmlFor="prompt" className="text-left  inline-block text-gray-700 text-sm font-bold mb-2">
                            prompt内容
                          </label>
                          <textarea
                            name="prompt"
